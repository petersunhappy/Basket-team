      ...
      <div className="md:w-1/2 p-6 md:p-10 flex items-center justify-center">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            <img 
              src="client/public/1-removebg-preview.png" 
              alt="1-removebg-preview.png" 
              className="mx-auto w-40 h-40 mb-4 rounded-full object-cover"
            />
            <CardTitle className="text-2xl font-bold text-secondary">LIONS Portal</CardTitle>
            <CardDescription>
