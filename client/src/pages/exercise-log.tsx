...
export default function ExerciseLog() {
  ...
  // Mutation to create new exercise
  const newExerciseForm = useForm({
    defaultValues: {
      name: "",
      description: "",
      category: "",
        ...
        <main className="flex-1 p-4 md:p-6">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex justify-between items-center mb-4">
              ...
              >
                {showNewExerciseForm ? "Voltar ao Registro" : "Criar Novo Exercício"}
              </Button>
            </div>
            ...
            {showNewExerciseForm ? (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Preencha os detalhes do novo exercício
                  </CardDescription>
                </CardHeader>
                <CardContent>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input placeholder="Ex: Arremesso livre" {...field} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
